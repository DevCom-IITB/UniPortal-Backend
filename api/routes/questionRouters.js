...
router.route('/upvoteA/:qid/:aid').patch(verifyRoles(ROLES_LIST.Admin,ROLES_LIST.STUDENT),upvoteA);
router.route('/hideQ/:qid').patch(verifyRoles(ROLES_LIST.Admin,ROLES_LIST.SMP),hideQ)
router.route('/hideA/:qid/:aid').patch(verifyRoles(ROLES_LIST.Admin,ROLES_LIST.SMP),hideA)
router.route('/hideC/:qid/:cid').patch(verifyRoles(ROLES_LIST.Admin,ROLES_LIST.SMP),hideC)
router.route('/hideAC/:qid/:aid/:cid').patch(verifyRoles(ROLES_LIST.Admin,ROLES_LIST.SMP),hideAC)
